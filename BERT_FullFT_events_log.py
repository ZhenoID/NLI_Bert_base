...
def evaluate_model(model, eval_loader, device, logger):
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        results = evaluate_model(model, eval_loader, device, logger)
    ...
    final_results = evaluate_model(model, eval_loader, device, logger)
